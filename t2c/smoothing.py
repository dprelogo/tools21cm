...
def smooth_lightcone(lightcone, z_array, box_size_mpc=False, max_baseline=2., ratio=1., redshift_smooth = False):
	"""
	...
	if redshift_smooth == False:
		output_lightcone = lightcone
	else:
